...
# from otrans.metrics import FocalLossPack
...
class Transformer(nn.Module):
    def __init__(self, params):
        ...
        # if params['loss'] == 'RELoss':
        #     self.crit = LabelSmoothingLoss(size=params['vocab_size'],
        #                                     smoothing=params['smoothing'])
        #
        # elif params['loss'] == 'FLLoss':
        #     self.crit = FocalLossPack(size=params['vocab_size'],
        #                                     smoothing=params['smoothing'])
    ...
    def forward(self, inputs, inputs_length, targets, targets_length):
        ...
        # 1. forward encoder
        enc_states, enc_mask = self.encoder(inputs, inputs_length, target_in)
